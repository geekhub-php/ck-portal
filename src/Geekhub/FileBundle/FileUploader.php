...
class FileUploader
{
    ...
    public function getMimeType($uploadDirectory)
    {
        $finfo = new \finfo(FILEINFO_MIME_TYPE, "/usr/share/misc/magic.mgc"); // возвращает mime-тип аля mimetype расширения

        /* получить mime-type для указанного файла */
        $filename = $uploadDirectory . '/' . $this->getName();
        return $finfo->file($filename);
    }

    public function getFileSize($uploadDirectory)
    {
        return filesize($uploadDirectory . '/' . $this->getName());
    }
